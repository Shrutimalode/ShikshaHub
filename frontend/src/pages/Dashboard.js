...
import { Container, Row, Col, Card, Button, Form, InputGroup, Spinner, Alert, Badge, Nav, Offcanvas, Tab, Tabs } from 'react-bootstrap';
...
const Dashboard = () => {
  ...
  const [currentTabKey, setCurrentTabKey] = useState('communities');
      ...
      <Row className="g-3">
        ...
        <Col md={8} xs={12}>
          ...
          >
            ...
            <Tab eventKey="discussions" title="Open Discussion Forum">
              <GlobalForum />
            </Tab>
          </Tabs>
        </Col>
