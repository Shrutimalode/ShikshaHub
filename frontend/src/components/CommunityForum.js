...
const CommunityForum = ({ communityId }) => {
  ...
  const handleCreatePost = async (e) => {
    ...
    try {
      ...
      await api.post(`/community-discussions/${communityId}`, postData);
  ...
  const handleReply = async (e) => {
    ...
    try {
      ...
      console.log('URL:', `/community-discussions/${communityId}`);

      const response = await api.post(`/community-discussions/${communityId}`, replyPayload);
  ...
  const handleUpdateDiscussion = async (e) => {
    ...
    try {
      ...
      await api.put(`/community-discussions/update/${editingDiscussion._id}`, updatePayload);
